...
var cache={}; function require(id){if(cache[id])return cache[id].exports;if(!modules[id])throw new Error('QR module '+id+' not found');var m={exports:{}};cache[id]=m;modules[id](m,m.exports,require);return m.exports;} global.KamelaQRCodeCore=require('index'); global.KamelaQRErrorCorrectLevel=require('QRErrorCorrectLevel');})(window);