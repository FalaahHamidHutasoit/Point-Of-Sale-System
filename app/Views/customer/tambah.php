            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-header bg-white border-0 px-4 pt-4">
                    ...
                    <small class="text-muted">
                        Isi informasi customer yang ingin didaftarkan.
                    </small>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-4">
                    ...
                    <p class="text-muted small mb-4">
                        Customer yang didaftarkan akan tersimpan
                        sebagai data pelanggan dan dapat dipilih
                    ...
                    <div class="info-list">
                        ...
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <small class="text-muted">
                                Nomor telepon dapat dikosongkan.
                            </small>
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <small class="text-muted">
                                Alamat dapat dilengkapi sesuai kebutuhan.
                            </small>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="d-flex align-items-start">
                        ...
                        <div>
                            ...
                            <small class="text-muted">
                                Pelanggan yang tidak terdaftar tetap dapat
                                melakukan transaksi menggunakan pilihan
                                <strong>Customer Umum</strong>.
                            </small>
