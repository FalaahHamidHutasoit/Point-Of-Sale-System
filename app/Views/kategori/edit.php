                    ...
                    <form action="<?= base_url('/kategori/update/' . $kategori['id_kategori']) ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group custom-input">
                                ...
                                <input type="text"
                                       class="form-control"
                                       value="<?= esc($kategori['id_kategori']) ?>"
                                       readonly>

                            </div>

                            <div class="form-text">
                                ID kategori tidak dapat diubah.
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-text">
                                Pastikan nama kategori jelas dan mudah dikenali.
                            </div>
            ...
            <div class="card info-card border-0">
                ...
                <div class="card-body p-4">
                    ...
                    <p class="text-muted small mb-3">
                        Perubahan nama kategori akan digunakan pada
                        data barang yang menggunakan kategori ini.
                    </p>
...
.custom-input .form-control[readonly] {
