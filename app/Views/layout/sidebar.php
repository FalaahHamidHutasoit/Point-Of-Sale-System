...
<div class="mobile-topbar d-none position-fixed top-0 start-0 end-0 bg-white border-bottom px-3 py-3 align-items-center justify-content-between" style="z-index:1100">
    <strong><i class="bi bi-shop me-2 text-primary"></i>NexaPOS</strong>
...
<aside class="sidebar">
    <div class="sidebar-brand">
        ...
        <div><strong>KAMELAH</strong><small>Retail Management</small></div>
    </div>
    ...
    <nav class="sidebar-menu">
        ...
        <?php if ($role === 'admin'): ?>
            ...
            <a class="sidebar-link <?= $active('stok') ?>" href="<?= base_url('stok/mutasi') ?>"><i class="bi bi-arrow-left-right"></i><span>Mutasi Stok</span></a>
    ...
    <div class="sidebar-user">
        ...
        <a href="<?= base_url('logout') ?>" class="logout-icon" title="Logout"><i class="bi bi-box-arrow-right"></i></a>
    </div>
</aside>
<style>
